...
## Methodology & Instrument Specifications — v0.5 (CONSULTATION DRAFT)
...
- **Contributor terms** — **all contributor classes, all input tiers.** These terms apply to every party who contributes data to any instrument, at any tier of §A3, whether an individual contributing a receipt or a venue contributing transaction records. **Protection:** individual contributions are confidential, used only in aggregate, and never attributed. **Attestation:** contributors attest that submissions reflect genuine transactions or firm quotes. **Compensation:** contributors receive, permanently and at no cost, **(a)** access to the full index, and **(b)** the data layer for the instrument they contribute to. Compensation survives any later decision to charge other users. **These terms are stated here once.** Elsewhere in this document they are cited and never restated: a second copy of a term sheet is a second place for it to be wrong, which is how the versions of this clause drifted apart in the first place.
...
Auction houses, dealers, lessors, and insurers may contribute transaction records under the contributor terms at §A10. Contributor recruitment status is reported annually.
